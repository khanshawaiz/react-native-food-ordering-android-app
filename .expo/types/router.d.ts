...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(admin)/` | `/(admin)` | `/(admin)/menu/create` | `/menu/create` | `/(admin)/menu/` | `/menu/` | `/(admin)/menu` | `/(admin)/menu/_layout` | `/menu/_layout` | `/(admin)/orders/` | `/orders/` | `/(admin)/orders` | `/(admin)/orders/list/archive` | `/orders/list/archive` | `/(admin)/orders/list/` | `/orders/list/` | `/(admin)/orders/list` | `/(admin)/orders/list/_layout` | `/orders/list/_layout` | `/(admin)/orders/_layout` | `/orders/_layout` | `/(admin)/_layout` | `/_layout` | `/(auth)/sign-in` | `/sign-in` | `/(auth)/sign-up` | `/sign-up` | `/(auth)/_layout` | `/(user)/` | `/(user)` | `/(user)/menu/` | `/(user)/menu` | `/(user)/menu/_layout` | `/(user)/orders/` | `/(user)/orders` | `/(user)/orders/_layout` | `/(user)/_layout` | `/cart` | `/(user)/profile` | `/profile`;
  // prettier-ignore
